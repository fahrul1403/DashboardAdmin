...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $jam = isset($_POST['jam_keberangkatan']) ? $_POST['jam_keberangkatan'] : "";
    $tujuan = isset($_POST['tujuan']) ? $_POST['tujuan'] : "";
    $peminta = isset($_POST['nama_peminta_izin']) ? $_POST['nama_peminta_izin'] : "";
    $pengemudi = isset($_POST['pengemudi']) ? $_POST['pengemudi'] : "";
    $nopolisi = isset($_POST['no_polisi']) ? $_POST['no_polisi'] : "";
    $atasan = isset($_POST['persetujuan_atasan']) ? $_POST['persetujuan_atasan'] : "";
    $koordinator = isset($_POST['koordinator_kendaraan']) ? $_POST['koordinator_kendaraan'] : "";
...
include("./backend/function.php");
$data = retrieveDataIzinKendaraan();
?>
...
<head>
    ...
    <title>Data Perizinan Kendaraan</title>
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4">Data Izin Kendaraan</h5>
                        <script>
                        DataTable('#example');
                        </script>
                        <table id="example" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= substr($row['jam_keberangkatan'], 0, 5); ?>
                                    </td>
                                    <td>
                                        <?= $row['persetujuan_atasan']; ?>
                                    </td>

                                    <td>
                                        <?= $row['koordinator_kendaraan']; ?>
                                    </td>
                                    <td>
                                        <a href="edit-data-izin.php?id=<?= $row['id']; ?>"
                                            class=" btn btn-info btn-sm">Edit</a>
                                        <a href="delete-data-izin.php?id=<?= $row['id']; ?>"
